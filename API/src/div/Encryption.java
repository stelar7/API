...
public class Encryption
{
    ...
    {
        final BigInteger publicKey = primitiveRoot.modPow(privateKey, prime);
        return publicKey;
    }
    ...
    {
        final BigInteger sharedSecret = publicKey.modPow(secretKey, prime);
    ...
    public static String generateDecryptMessage(final String pass, final String out)
    {
        try
        {
            ...
            final String plaintext = new String(cipher.doFinal(ciphertext), "UTF-8");
